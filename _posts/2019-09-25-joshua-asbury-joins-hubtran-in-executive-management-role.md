---
id: 981
title: Joshua Asbury Joins HubTran in Executive Management Role
date: 2019-09-25T21:36:36-04:00
author: Josh Asbury
excerpt: HubTran has named Josh Asbury to head the company’s key 3PL segment. Josh brings the expertise he gained building sales, sales engineering, and customer service teams at Liferay, an open source digital experience platform. In his VP role at HubTran, Asbury is charged with accelerating the company’s already impressive growth and market presence.
layout: post
guid: https://hubtran.wpmudev.host/?p=981
permalink: /joshua-asbury-joins-hubtran-in-executive-management-role/
...
eg-post-author:
  - Matt Bernstein
image: /wp-content/uploads/2019/09/HubTran_Website_Headshots_JoshAsbury.png
categories:
  - 3PL
  - Bottom Section
...
\[/vc\_column\_text\]\[/vc\_column\_inner\]\[/vc\_row\_inner\]\[vc\_empty\_space height=&#8221;60px&#8221;\]\[/vc\_column\]\[/vc\_row\]\[vc\_row css\_animation=&#8221;&#8221; row\_type=&#8221;row&#8221; use\_row\_as\_full\_screen\_section=&#8221;no&#8221; type=&#8221;grid&#8221; angled\_section=&#8221;no&#8221; text\_align=&#8221;left&#8221; background\_image\_as\_pattern=&#8221;without\_pattern&#8221; el\_class=&#8221;case-study-individual-page-content&#8221; z\_index=&#8221;&#8221;\]\[vc\_column el\_id=&#8221;case-study-body-content-row&#8221;\]\[vc\_empty\_space\]\[vc\_column\_text\]
...
<div id="author-section">
  ...
  <div id="author-name">
    <h2 class="h2-case-study-category-title">
      <span style="color: #5e6970;"><strong>Matt Bernstein</strong> | September 24, 2019</span>
    </h2>
...
# <span style="color: #5e6970;">Joshua Asbury Joins HubTran in Executive Management Role</span> {.h1-case-study-title}

\[/vc\_column\_text\]\[vc\_empty\_space height=&#8221;30px&#8221;\][vc\_column\_text]Chicago, IL — HubTran, the transportation industry’s leading back-office automation platform, has named Josh Asbury to head the company’s key 3PL segment. Josh brings the expertise he gained building sales, sales engineering, and customer service teams at Liferay, an open source digital experience platform. In his VP role at HubTran, Asbury is charged with accelerating the company’s already impressive growth and market presence.

&nbsp;

Matt Bernstein, CEO HubTran, looks forward to Josh’s contributions. “Josh has a track record of building and commercializing technology that delivers outsized value. With Josh at the helm, HubTran will offer even more innovation, great service, and cost-saving solutions to our 3PL customers,” said Bernstein.

&nbsp;

While at Liferay, Asbury served as VP of Sales for the Americas. In this role, Josh helped the company enjoy a 25% growth rate, expand from 50 to over 900 employees, open multiple international offices, and maintain its standing as a leader in Gartner’s Magic Quadrant for Horizontal Portals. In addition to his Liferay experience, Asbury served as Vice-Chairman of the Board for the Hamilton Mill — an Ohio-based startup incubator.

&nbsp;

Asbury on HubTran and the future: “Every industry is undergoing swift digital transformation to achieve operational efficiencies and deliver superior customer experiences. The logistics world and HubTran have been at the forefront, and I’m excited to join the company at a time when customers are ready to take advantage of artificial intelligence and machine learning. Hubtran has created a phenomenal business, and I look forward to helping them accelerate that growth by bringing tremendous value to our customers.”\[/vc\_column\_text\]\[vc\_empty\_space height=&#8221;30px&#8221;\][vc\_column\_text]**About HubTran:**<span class="Apple-converted-space"> </span>
